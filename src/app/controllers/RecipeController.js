...
module.exports = {
    async list(req, res) {
        ...
        return res.render("admin-access/recipe/list", { recipes, session: req.session, sessionIsAdmin });
    },
    ...
    async create(req, res) {
        ...
        return res.render("admin-access/recipe/create", { chefOptions: options, session: req.session });
    ...
    async post(req, res) {
        ...
        for (key of keys) {
            if (req.body[key] == "" && key != "information") {
                return res.render("admin-access/recipe/create", { 
                    session: req.session,
        ...
        return res.render("admin-access/recipe/show", { 
            recipe, 
            files, 
            session: req.session, 
            sessionIsAdmin,
    ...
    async show(req, res) {
        ...
        return res.render("admin-access/recipe/show", { recipe, files, session: req.session, sessionIsAdmin });
    },
    ...
    async edit(req, res) {
        ...
        return res.render("admin-access/recipe/edit", { recipe, chefOptions: options, files, session: req.session });
    },
    ...
    async delete(req, res) {
        ...
        return res.render("admin-access/recipe/list", { 
            recipes, 
            session: req.session, 
            sessionIsAdmin,
